<div class="app-menu">
    ...
    <!-- Sidenav Brand Logo -->
    <div href="#" class="logo-box">
        <!-- Light Brand Logo -->
        <div class="flex">
            <div>
                <img src="/images/logo.png" class="logo-lg h-12" height="50" style="height: 50px;" alt="Light logo">
                <img src="/images/logo.png" class="logo-sm" alt="Small logo">
            </div>
            {{-- <div>
                <div>Informa Team</div>
            </div> --}}
        </div>
        ...
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="{{ route('products.index') }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_shopping_bag_2_line"></i></span>
            ...
            <li class="menu-item">
                <a href="{{ route('categories.index') }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_folder_line"></i></span>
            ...
            <li class="menu-item">
                <a href="{{ route('courses.index') }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_book_2_line"></i></span>
