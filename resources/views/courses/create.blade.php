                        ...
                        <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="By" id="By" value="{{ old('By') }}"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                ...
                                <div class="mb-6">
                                    <label for="num_video"
                                        ...
                                        Videos</label>
                                    <input type="text" name="num_video" id="num_video" value="{{ old('num_video') }}"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="telegram_link" id="telegram_link"
                                        value="{{ old('telegram_link') }}" placeholder="https://t.me/example"
                                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            </div>
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Recommended size: 800x600 pixels.
                                    Max size: 2MB.</p>
                                @error('image')
