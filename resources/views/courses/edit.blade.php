@extends('layouts.vertical', ['title' => 'Edit Course', 'sub_title' => 'Courses', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="max-w-7xl mx-auto">
            <div class="w-full">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <h4 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Course</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <form action="{{ route('courses.update', $course->id) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="Name" id="Name" value="{{ old('Name', $course->Name) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                </div>

                                <div class="mb-6">
                                    <label for="By" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Instructor</label>
                                    <input type="text" name="By" id="By" value="{{ old('By', $course->By) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="type" id="type" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        ...
                                        <option value="Text" {{ old('type', $course->type) == 'Text' ? 'selected' : '' }}>Text</option>
                                        <option value="Mixed" {{ old('type', $course->type) == 'Mixed' ? 'selected' : '' }}>Mixed</option>
                                    </select>
                                </div>

                                <div class="mb-6">
                                    <label for="duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Duration</label>
                                    <input type="text" name="duration" id="duration" value="{{ old('duration', $course->duration) }}" placeholder="e.g. 2 hours" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>

                                <div class="mb-6">
                                    <label for="num_video" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Number of Videos</label>
                                    <input type="text" name="num_video" id="num_video" value="{{ old('num_video', $course->num_video) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>

                                <div class="mb-6">
                                    <label for="released_at" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Release Date</label>
                                    <input type="date" name="released_at" id="released_at" value="{{ old('released_at', $course->released_at) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <select name="categories_id" id="categories_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('categories_id', $course->categories_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="telegram_link" id="telegram_link" value="{{ old('telegram_link', $course->telegram_link) }}" placeholder="https://t.me/example" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                </div>
                            </div>
