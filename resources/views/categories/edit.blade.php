@extends('layouts.vertical', ['title' => 'Edit Category', 'sub_title' => 'Categories', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="max-w-7xl mx-auto">
            <div class="w-full">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <h4 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Category</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                    ...
                    <div class="p-6">
                        <form action="{{ route('categories.update', $category) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                            </div>
