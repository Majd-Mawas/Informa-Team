                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex justify-between items-center">
                            <h4 class="text-lg font-medium text-gray-900 dark:text-white">Articles List</h4>
                                        ...
                                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                            @foreach ($articles as $article)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        @if ($article->path)
                                                            <img src="{{ asset('storage/' . $article->path) }}"
                                                                alt="{{ $article->title }}" class="rounded" height="48">
                                                        @else
                                                    ...
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                        {{ $article->author_name }}</td>
                                                    <td
                                                        class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">
                                                        {{ \Carbon\Carbon::parse($article->released_at)->format('M d, Y') }}</td>
